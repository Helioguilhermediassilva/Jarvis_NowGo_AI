    ...
    sobre: {
      ...
      founder: {
        ...
        body: [
          ...
          "Hélio reúne equipe técnica nacional com bases em telecom e no setor de Justiça (CNJ), e teve passagens pelo Banco Mundial e pelas Nações Unidas — neste último, como consultor de Climate & Energy Transition, mapeando mecanismos internacionais de financiamento climático para apoiar a transição energética na América Latina. Hoje está 100% dedicado à NowGo AI — a empresa que materializa, em escala, aquela visão de cidade, empresa e serviço público verdadeiramente humanos.",
          "Em paralelo, atuou como VP na <strong>RiverRock Films (Hollywood)</strong>, liderando captação global de recursos e parcerias institucionais a partir do Brasil — experiência que ampliou sua atuação para o mercado de mídia e entretenimento internacional, hoje refletida no vertical Entertainment da NowGo AI.",
    ...
    sobre: {
      ...
      founder: {
        ...
        body: [
          ...
          "Hélio leads a national technical team with backgrounds in telecom and the Brazilian Justice sector (CNJ), and has worked on World Bank and United Nations projects — for the UN, as a Climate & Energy Transition consultant, mapping international climate finance mechanisms to support energy transition in Latin America. He is now 100% dedicated to NowGo AI — the company that materializes, at scale, that vision of truly human cities, enterprises and public services.",
          "In parallel, he served as VP at <strong>RiverRock Films (Hollywood)</strong>, leading global fundraising and institutional partnerships from Brazil — an experience that extended his reach into the international media and entertainment market, today reflected in NowGo AI's Entertainment vertical.",
    ...
    sobre: {
      ...
      founder: {
        ...
        body: [
          ...
          "Hélio reúne un equipo técnico nacional con bases en telecom y en el sector de Justicia (CNJ), y tuvo paso por el Banco Mundial y por las Naciones Unidas — en este último, como consultor de Climate & Energy Transition, mapeando mecanismos internacionales de financiamiento climático para apoyar la transición energética en América Latina. Hoy está 100% dedicado a NowGo AI — la empresa que materializa, a escala, aquella visión de ciudad, empresa y servicio público verdaderamente humanos.",
          "En paralelo, actuó como VP en <strong>RiverRock Films (Hollywood)</strong>, liderando captación global de recursos y alianzas institucionales desde Brasil — experiencia que amplió su actuación al mercado internacional de medios y entretenimiento, hoy reflejada en la vertical Entertainment de NowGo AI.",
