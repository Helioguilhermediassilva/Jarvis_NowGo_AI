    ...
    sobre: {
      ...
      founder: {
        ...
        body: [
          ...
          "É presidente da AACMB — Associação dos ex-alunos do Colégio Militar de Brasília, rede de cerca de 80 mil famílias que inclui empresários, artistas, ministros e o atual governador de São Paulo. É também Embaixador Brasileiro e Global Board Member do Global Financial Literacy Movement, iniciativa global que alcança 14 universidades africanas, mais de 40 parceiros de mídia e 12 milhões de pessoas em escala global — com expansão ativa nos Estados Unidos, Europa, África e Ásia. Coopera ainda com o MEC e o Centro de Estudos Estratégicos Brasileiros para o desenvolvimento de LLMs em português.",
    ...
    sobre: {
      ...
      founder: {
        ...
        body: [
          ...
          "Es presidente de AACMB — Asociación de exalumnos del Colegio Militar de Brasilia, red de cerca de 80 mil familias que incluye empresarios, artistas, ministros y el actual gobernador de São Paulo. Es además Embajador Brasileño y Global Board Member del Global Financial Literacy Movement, iniciativa global que alcanza 14 universidades africanas, más de 40 socios de medios y 12 millones de personas a escala global — con expansión activa en Estados Unidos, Europa, África y Asia. Coopera además con el MEC y el Centro de Estudios Estratégicos Brasileños para el desarrollo de LLMs en portugués.",
