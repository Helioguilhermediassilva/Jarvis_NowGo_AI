  ...
  pt: {
    ...
    pricing: {
      ...
      selfService: {
        ...
        billingChoiceTitle: "Como você deseja pagar?",
        monthlyOption: "Mensal · cobrança recorrente",
        annualOption: "Anual · cobrança única",
        annualBadge: "2 meses grátis",
        trialChoiceTitle: "Escolha como começar",
        payNowOption: "Pagar agora",
        trialOption: "Começar com 14 dias grátis",
        payNowDescription: "A cobrança começa imediatamente após a confirmação no Stripe.",
        trialDescription: "O cartão é solicitado no Stripe e a cobrança começa após 14 dias, conforme as condições exibidas.",
        plans: [
          {
  ...
  en: {
    ...
    pricing: {
      ...
      selfService: {
        ...
        billingChoiceTitle: "How would you like to pay?",
        monthlyOption: "Monthly · recurring billing",
        annualOption: "Annual · one-time charge",
        annualBadge: "2 months free",
        trialChoiceTitle: "Choose how to start",
        payNowOption: "Pay now",
        trialOption: "Start with 14 free days",
        payNowDescription: "Billing begins immediately after confirmation in Stripe.",
        trialDescription: "A card is collected in Stripe and billing begins after 14 days, according to the terms shown.",
        plans: [
          {
            code: "sovereign_platform_pro_monthly",
  ...
  es: {
    ...
    pricing: {
      ...
      selfService: {
        ...
        billingChoiceTitle: "¿Cómo desea pagar?",
        monthlyOption: "Mensual · cobro recurrente",
        annualOption: "Anual · cobro único",
        annualBadge: "2 meses gratis",
        trialChoiceTitle: "Elija cómo empezar",
        payNowOption: "Pagar ahora",
        trialOption: "Empezar con 14 días gratis",
        payNowDescription: "El cobro comienza inmediatamente después de la confirmación en Stripe.",
        trialDescription: "La tarjeta se solicita en Stripe y el cobro comienza después de 14 días, según las condiciones mostradas.",
        plans: [
          {
            code: "sovereign_platform_pro_monthly",
