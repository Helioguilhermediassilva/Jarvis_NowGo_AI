...
export const copy = {
  pt: {
    ...
    pricing: {
      ...
      enterpriseEyebrow: "PROGRAMAS ENTERPRISE",
      enterpriseTitle: "Implementações sob medida para empresas e governos.",
      selfService: {
        eyebrow: "ACESSO SELF-SERVICE",
        title: "Plataforma de Inteligência Soberana para operar agora.",
        subtitle: "Assinaturas com créditos mensais, memória por sessão e possibilidade de ampliar o uso com pacotes adicionais.",
        plans: [
          {
  ...
  en: {
    ...
    pricing: {
      ...
      enterpriseEyebrow: "ENTERPRISE PROGRAMS",
      enterpriseTitle: "Tailored implementations for enterprises and governments.",
      selfService: {
        eyebrow: "SELF-SERVICE ACCESS",
        title: "Sovereign Intelligence Platform, ready to operate now.",
        subtitle: "Subscriptions with monthly credits, session-based memory and the option to expand usage with additional packs.",
        plans: [
          {
            code: "sovereign_platform_pro_monthly",
  ...
  es: {
    ...
    pricing: {
      ...
      enterpriseEyebrow: "PROGRAMAS ENTERPRISE",
      enterpriseTitle: "Implementaciones a medida para empresas y gobiernos.",
      selfService: {
        eyebrow: "ACCESO SELF-SERVICE",
        title: "Plataforma de Inteligencia Soberana para operar ahora.",
        subtitle: "Suscripciones con créditos mensuales, memoria por sesión y opción de ampliar el uso con paquetes adicionales.",
        plans: [
          {
            code: "sovereign_platform_pro_monthly",
