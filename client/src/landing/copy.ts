  ...
  pt: {
    ...
    verticals: {
      ...
      items: [
        ...
        { name: "Agri", desc: "Otimização de safra, suporte a cooperativas e agentes para gestão de propriedades rurais." },
    ...
    cases: {
      ...
      items: [
        {
          ...
          desc: "Implementação inicial em curso na esfera de governo, com escopo de expansão direto para R$ 10MM, R$ 20MM e R$ 100MM em fases subsequentes.",
        },
        {
          tag: "SAÚDE / RECORRÊNCIA",
          title: "Triad — Agente de IA com receita recorrente",
          metric: "R$ 100K + R$ 3,5K/mês",
          metricLabel: "Setup + MRR",
          desc: "Cliente em produção com contrato assinado. Modelo replicável de setup + recorrência mensal aplicado à área da saúde e correlatos.",
        },
        {
          tag: "JURÍDICO",
      ...
      footer:
        "Todos os valores em BRL. Pipeline aberto adicional de R$ 63,07 MM em 108 oportunidades qualificadas. Atualização em tempo real no cockpit interno.",
    },
    seals: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        },
        {
          ...
          desc: "LLM proprietária treinada nos seus dados. Quatro marcos contratuais (30/25/25/20). Após go-live, recorrência de R$ 180K/mês para licenciamento, suporte e novos modelos.",
          features: [
            "LLM dedicada com seus dados privados",
            "Infraestrutura GPU sob medida",
            "Suporte premium 12 meses inclusos",
            "Recorrência R$ 180K/mês após go-live",
        ...
        },
        {
          ...
          price: "R$ 10 MM a R$ 100 MM",
          period: "Programa plurianual por fases",
          desc: "Plataforma Pública Integrada para governos. Fase 1 a partir de R$ 1,58 MM, com expansão programada para R$ 10MM, R$ 20MM e R$ 100MM por etapa.",
          features: [
  ...
  en: {
    ...
    verticals: {
      ...
      items: [
        ...
        { name: "Agri", desc: "Crop optimization, support for cooperatives and agents for rural property management." },
    ...
    cases: {
      ...
      items: [
        {
          ...
          desc: "Initial implementation underway at the government level, with expansion scope directly to BRL 10MM, 20MM and 100MM in subsequent phases.",
        },
        {
          tag: "HEALTH / RECURRING",
          title: "Triad — AI Agent with recurring revenue",
          metric: "BRL 100K + 3.5K/mo",
          metricLabel: "Setup + MRR",
          desc: "Client in production with a signed contract. Replicable setup + monthly recurring model applied to healthcare and adjacent sectors.",
        },
        {
          tag: "LEGAL",
      ...
      footer:
        "All values in BRL. Additional open pipeline of BRL 63.07 MM across 108 qualified opportunities. Real-time updates in the internal cockpit.",
    },
    seals: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        },
        {
          ...
          desc: "Proprietary LLM trained on your data. Four contractual milestones (30/25/25/20). After go-live, BRL 180K/month recurring fee for licensing, support and new models.",
          features: [
            "Dedicated LLM with your private data",
            "Tailored GPU infrastructure",
            "Premium support included for 12 months",
            "BRL 180K/month recurring after go-live",
        ...
        },
        {
          ...
          price: "BRL 10 MM to 100 MM",
          period: "Multi-year phased program",
          desc: "Integrated Public Platform for governments. Phase 1 starts at BRL 1.58 MM, with planned expansion to BRL 10MM, 20MM and 100MM per stage.",
          features: [
