...
export const copyIaNoBrasil: Record<Lang, ArticleCopy> = {
  /* ------------------------------------------------------------------ PT */
  pt: {
    seoTitle:
  ...
  en: {
    ...
    title: "Artificial Intelligence in Brazil: why sovereignty is the strategic decision of the decade",
    subtitle:
      "The AI race has become geopolitical. Between American and Chinese models, the question that matters for Brazilian companies and governments is a different one: who controls the data, the models and the decisions?",
    breadcrumbName: "AI in Brazil",
    tocLabel: "In this guide",
    toc: [
      { href: "#corrida", label: "The global race: US, China and everyone else" },
      ...
      { href: "#agenda", label: "The agenda for Brazilian companies and governments" },
    ...
    sections: [
      {
        kind: "text",
        id: "corrida",
        heading: "The global race: US, China and everyone else",
        paragraphs: [
          '<a href="/en/blog/inteligencia-artificial">Artificial intelligence</a> is no longer a contest between companies — it has become a contest between powers. The United States leads in frontier models and concentrates the chip and cloud infrastructure; China responded with competitive models and an explicit AI industrial strategy. Chip export controls, data centers treated as strategic assets and models used as instruments of influence make up the new chessboard.',
          "For every other country, this scenario poses a quiet but decisive choice: be merely a <em>consumer</em> of intelligence produced elsewhere — exporting data and importing decisions — or build layers of native capability on top of what the world offers. It is the same crossroads the world has already seen with energy, telecommunications and finance. In all of them, those who treated critical infrastructure as a commodity paid dearly later.",
        ],
      },
      {
        kind: "text",
        ...
        paragraphs: [
          "The Brazilian picture has two sides. The side of <strong>dependency</strong>: AI adoption by companies and governments is growing fast, but almost entirely on foreign models and clouds — with sensitive data from citizens, patients and critical operations processed outside national jurisdiction, recurring costs in dollars and zero ability to audit the models.",
          "The side of <strong>assets</strong>: Brazil holds one of the largest digitized public data bases in the world — the SUS public health system, digital government, a financial system with Pix and Open Finance —, recognized technical talent and a continental-scale domestic market. Few countries combine, at the same time, so much raw material (data and demand) and so much dependence on other people's intelligence. Closing that gap is the opportunity of the decade.",
        ],
      },
      {
        kind: "text",
        ...
        paragraphs: [
          ...
          "Sovereign AI <strong>is</strong> control over what is critical: (1) <strong>resident data</strong> — sensitive information processed on infrastructure under national jurisdiction or the organization's own control; (2) <strong>auditable, specialized models</strong> — the ability to inspect, adjust and train models on local reality, from public-health vocabulary to Brazilian legal rules; (3) <strong>strategic autonomy</strong> — critical functions that do not stop if a foreign vendor changes price, policy or availability.",
          "With high-quality open models and GPU infrastructure available in the country, this architecture is no longer a superpower privilege: it is a design decision within reach of hospitals, companies and subnational governments.",
        ],
      },
      {
        kind: "cta",
        title: "Sovereign AI infrastructure",
        text: "NowGo AI designs and deploys your organization's sovereign layer: custom LLMs, agents and orchestration running on resident data — with the best of global technology wherever it does not compromise control.",
        waMsg:
          "Hello! I read NowGo AI's article on sovereign AI and I'd like to discuss sovereign infrastructure for my organization.",
      ...
      },
      {
        ...
        paragraphs: [
          "Mature sovereign architecture is <strong>hybrid and modular</strong>. Sensitive data and critical functions run on specialized models over controlled infrastructure; generic, non-sensitive tasks can use global platforms, with a clear policy on what flows where. Between the two layers, an <strong>orchestration layer</strong> decides, records and audits — AI agents operate inside it, with permissions and a complete trail.",
          'The design principles are the same we apply to every project: modular (each capability is a module that integrates, not a silo), interoperable (it talks to existing systems), enterprise-grade and government-grade (security, audit and compliance — including Brazil\'s LGPD — from the start). It is the standard of the <a href="/">NowGo AI platform</a> for healthcare, cities, education and industry.',
        ],
      },
      {
        kind: "text",
        id: "agenda",
        heading: "The agenda for Brazilian companies and governments",
        paragraphs: [
          "<strong>For companies:</strong> map which data and functions are too critical to depend on third parties; start specializing models with the business's proprietary knowledge — increasingly the only differentiator a competitor cannot copy by hiring the same platform.",
          "<strong>For governments:</strong> treat citizens' data as a strategic asset under national jurisdiction; require auditability and data residency in AI procurement; and use public purchasing power to develop local capability — as today's leading countries did.",
    ...
    faq: [
      {
        ...
        a: "Sovereign AI is the capacity of an organization or country to develop and operate AI systems under its own control: data processed on infrastructure under national jurisdiction, models that can be audited and specialized for local reality, and strategic independence from foreign platforms for critical functions. It does not mean technological isolation — it means control over what is critical.",
      },
      {
        q: "What is the state of artificial intelligence in Brazil today?",
        a: "Brazil combines fast AI adoption by companies and governments with near-total dependence on foreign models and clouds. At the same time, the country holds real assets: one of the world's largest digitized public data bases (healthcare, digital government, financial system), technical talent and continental-scale domestic demand — the conditions to build a sovereign AI layer instead of merely consuming others'.",
      },
      {
        q: "Why not just use ChatGPT, Gemini and other global platforms?",
        a: "For individual use and generic tasks, they are excellent. The problem appears in critical functions of companies and governments: sensitive citizen and patient data flowing outside national jurisdiction, no ability to audit the model, dependence on third parties' commercial and geopolitical decisions, and recurring costs in foreign currency. For those functions, the right architecture combines the best of global models with sovereign layers where it matters.",
      },
      {
        q: "Is sovereign AI feasible for a single organization, or only for countries?",
        a: "It is feasible — and increasingly accessible. High-quality open models, GPU infrastructure available locally and specialization techniques (fine-tuning, RAG) allow hospitals, companies and governments to operate world-class AI with data resident on their own or national infrastructure. It is an architecture decision, not a superpower budget.",
      },
    ],
    finalTitle: "Build your organization's sovereign layer",
    finalSub:
      "Talk to the team that designs sovereign AI infrastructure for companies, governments and cities — module by module, with control and audit from the design stage.",
  ...
  es: {
    ...
    title: "Inteligencia Artificial en Brasil: por qué la soberanía es la decisión estratégica de la década",
    subtitle:
    ...
    sections: [
      {
        ...
        paragraphs: [
          'La <a href="/es/blog/inteligencia-artificial">inteligencia artificial</a> dejó de ser una disputa entre empresas y se convirtió en una disputa entre potencias. Estados Unidos lidera en modelos de frontera y concentra la infraestructura de chips y nube; China respondió con modelos competitivos y una estrategia industrial explícita de IA. Controles de exportación de chips, data centers tratados como activos estratégicos y modelos usados como instrumento de influencia componen el nuevo tablero.',
          "Para los demás países, este escenario plantea una elección silenciosa pero decisiva: ser solo <em>consumidor</em> de inteligencia producida afuera — exportando datos e importando decisiones — o construir capas propias de capacidad sobre lo que el mundo ofrece. Es la misma encrucijada que el mundo ya vio con la energía, las telecomunicaciones y el sistema financiero. En todas, quien trató la infraestructura crítica como commodity pagó caro después.",
        ],
      },
      {
        kind: "text",
        ...
        paragraphs: [
          "El retrato brasileño tiene dos lados. El lado de la <strong>dependencia</strong>: la adopción de IA por empresas y gobiernos crece rápido, pero casi enteramente sobre modelos y nubes extranjeros — con datos sensibles de ciudadanos, pacientes y operaciones críticas procesados fuera de la jurisdicción nacional, costos recurrentes en dólares y cero capacidad de auditoría sobre los modelos.",
          "El lado de los <strong>activos</strong>: Brasil tiene una de las mayores bases de datos públicos digitalizados del mundo — el sistema público de salud (SUS), el gobierno digital, el sistema financiero con Pix y Open Finance —, talento técnico reconocido y un mercado interno de escala continental. Pocos países tienen, al mismo tiempo, tanta materia prima (datos y demanda) y tanta dependencia de la inteligencia ajena. Cerrar esa distancia es la oportunidad de la década.",
        ],
      },
      {
        kind: "text",
        ...
        paragraphs: [
          "IA soberana <strong>no es</strong> aislamiento tecnológico, ni rechazar los modelos globales, ni reinventar todo desde cero. Eso sería caro, lento y contraproducente.",
          "IA soberana <strong>es</strong> control sobre lo crítico: (1) <strong>datos residentes</strong> — información sensible procesada en infraestructura bajo jurisdicción y control nacional o de la propia organización; (2) <strong>modelos auditables y especializados</strong> — la capacidad de inspeccionar, ajustar y entrenar modelos con la realidad local; (3) <strong>autonomía estratégica</strong> — funciones críticas que no se detienen si un proveedor extranjero cambia precio, política o disponibilidad.",
          "Con modelos abiertos de alta calidad e infraestructura de GPU disponible localmente, esa arquitectura dejó de ser privilegio de superpotencias: es una decisión de diseño al alcance de hospitales, empresas y gobiernos subnacionales.",
        ],
      },
      {
        kind: "cta",
        title: "Infraestructura soberana de IA",
        text: "NowGo AI diseña e implementa la capa soberana de su organización: LLMs personalizados, agentes y orquestación operando sobre datos residentes — con lo mejor de la tecnología global donde no compromete el control.",
        waMsg:
      ...
      },
      {
        ...
        paragraphs: [
          "<strong>Para empresas:</strong> mapear qué datos y funciones son demasiado críticos para depender de terceros; comenzar a especializar modelos con el conocimiento propietario del negocio — cada vez más, el único diferencial que un competidor no copia contratando la misma plataforma.",
          ...
          "<strong>Para ambos:</strong> comenzar ahora, por un módulo, con un indicador claro — y escalar sobre la misma infraestructura. La soberanía no se decreta; se construye, proyecto a proyecto. Y cada proyecto construido sobre arquitectura dependiente es retrabajo futuro garantizado.",
        ],
      },
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Para uso individual y tareas genéricas, son excelentes. El problema aparece en funciones críticas de empresas y gobiernos: datos sensibles de ciudadanos y pacientes circulando fuera de la jurisdicción nacional, imposibilidad de auditar el modelo, dependencia de decisiones comerciales y geopolíticas de terceros, y costos recurrentes en moneda extranjera. Para esas funciones, la arquitectura correcta combina lo mejor de los modelos globales con capas soberanas donde importa.",
      },
      {
    ...
    finalSub:
      "Converse con quien diseña infraestructura soberana de IA para empresas, gobiernos y ciudades — módulo a módulo, con control y auditoría desde el diseño.",
