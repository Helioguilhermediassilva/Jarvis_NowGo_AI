...
export const copyAgentesDeIa: Record<Lang, ArticleCopy> = {
  /* ------------------------------------------------------------------ PT */
  pt: {
    seoTitle:
    ...
    sections: [
      {
        ...
        paragraphs: [
          'An AI agent is a system that receives a goal — "confirm tomorrow\'s appointments", "reconcile these payments", "answer this citizen request" — and executes the steps needed to accomplish it: it queries systems, makes decisions within defined rules, triggers other tools and reports the result. It is the natural evolution of generative <a href="/en/blog/inteligencia-artificial">artificial intelligence</a>: the language model stops merely conversing and starts operating.',
          'The distinction matters because it changes the question the organization should ask. With chatbots, the question was "how can AI help my team answer faster?". With agents, the question becomes "which entire processes can I delegate, keeping human supervision at the points that matter?".',
        ],
      },
      {
        kind: "text",
        ...
        paragraphs: [
          ...
          "<strong>Autonomous agent</strong> — receives the goal and drives the flow end to end, triggering systems and people when needed. It operates 24/7, at scale, with every action recorded. This is the level at which AI becomes part of the organization's operational capacity — and the level that demands real architecture and governance.",
        ],
      },
      {
        kind: "text",
        ...
        paragraphs: [
          "Every agent combines four components. The <strong>brain</strong> is a language model (LLM) — in corporate and public contexts, ideally customized with the organization's vocabulary, rules and data. <strong>Memory and context</strong> connect the agent to the operation's sources of truth: calendar, ERP, CRM, medical records, databases. <strong>Tools</strong> are the actions it can execute — send a message, update a record, make a voice call, trigger another system. And <strong>orchestration</strong> is the layer that coordinates everything: it defines what the agent can do alone, what requires human approval, and how each step is recorded for audit.",
          'That is why isolated agents, bought as standalone apps, deliver little: without integration with real systems and without an orchestration layer, the "agent" reverts to being a chatbot. The value lies in the infrastructure connecting models, data and systems — modular, interoperable and under the organization\'s control.',
        ],
      },
      {
        kind: "cta",
      ...
      },
      {
        ...
        paragraphs: [
          "<strong>Voice service</strong> — agents that answer and make calls in natural language: scheduling and confirmation in healthcare, citizen services in the public sector, collections and after-sales in companies.",
          "<strong>Back office</strong> — financial reconciliation, billing verification, follow-up of pending items, record updates: repetitive multi-step flows the agent executes in the organization's own systems.",
          "<strong>Management and decision-making</strong> — agents that monitor indicators, cross-reference public and internal databases and produce operational briefings for managers, turning scattered data into daily decisions. It is the pattern that guides urban and corporate orchestration platforms.",
        ],
      },
      {
        kind: "text",
        ...
        paragraphs: [
          "Autonomy without governance is a liability, not an asset. Four principles separate mature projects from risky experiments: <strong>least privilege</strong> (the agent only accesses what the task requires), <strong>human approval</strong> for sensitive or irreversible actions, an <strong>audit trail</strong> of every action executed, and <strong>sovereignty</strong> — data and models running on infrastructure under the organization's control and jurisdiction, a non-negotiable requirement for governments and regulated sectors.",
    ...
    faq: [
      {
        ...
        a: "An AI agent is a system that, beyond understanding and generating language, executes actions to accomplish a goal: it queries systems, fills in records, sends communications, triggers other software and drives multi-step workflows — with human supervision defined at critical points. The difference from a chatbot is the verb: the chatbot answers; the agent does.",
      },
      {
      ...
      {
        q: "Where should I start with AI agents?",
        a: "With the highest-volume repetitive process with the clearest rules: voice confirmation and scheduling, request triage, reconciliations and back-office follow-ups. A tightly scoped pilot, with a numeric indicator and human supervision, proves value within weeks and sets the governance standard for scaling.",
      },
    ],
    finalTitle: "Ready to put AI agents to work?",
    finalSub:
      "Diagnosis of the processes with the greatest automation potential and design of an agent architecture with governance — straight to the point, no commitment.",
  ...
  es: {
    ...
    sections: [
      {
        ...
        paragraphs: [
          'Un agente de IA es un sistema que recibe un objetivo — "confirma las consultas de mañana", "concilia estos pagos", "responde esta solicitud del ciudadano" — y ejecuta las etapas necesarias para cumplirlo: consulta sistemas, toma decisiones dentro de reglas definidas, acciona otras herramientas y reporta el resultado. Es la evolución natural de la <a href="/es/blog/inteligencia-artificial">inteligencia artificial</a> generativa: el modelo de lenguaje deja de solo conversar y pasa a operar.',
          'La distinción importa porque cambia la pregunta que la organización debe hacer. Con chatbots, la pregunta era "¿cómo puede la IA ayudar a mi equipo a responder más rápido?". Con agentes, la pregunta pasa a ser "¿qué procesos enteros puedo delegar, manteniendo supervisión humana en los puntos que importan?".',
        ],
      },
      {
        kind: "text",
        ...
        paragraphs: [
          ...
          "<strong>Copiloto</strong> — trabaja lado a lado con una persona dentro de una herramienta: redacta el borrador, sugiere el código, resume la reunión. La productividad sube, pero el ritmo sigue limitado por la jornada humana.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "<strong>Gestión y decisión</strong> — agentes que monitorean indicadores, cruzan bases públicas e internas y producen briefings operativos para gestores, transformando datos dispersos en decisiones diarias. Es el patrón que orienta las plataformas de orquestación urbana y corporativa.",
        ],
      },
      {
        kind: "text",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Sí, cuando se diseñan con salvaguardas: permisos mínimos por tarea, puntos de aprobación humana en acciones sensibles, trazabilidad completa de todo lo que el agente hizo e infraestructura bajo control de la organización. Un agente sin gobernanza es un riesgo; un agente con la arquitectura correcta es fuerza de trabajo digital auditable.",
      },
      {
